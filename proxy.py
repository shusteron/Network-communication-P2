...
def proxy(proxy_address: tuple[str, int], server_adress: tuple[str, int]) -> None:
    ...
    with socket.socket(socket.AF_INET, socket.SOCK_STREAM) as proxy_socket:
        ...
        # * Fill in start (1)
        proxy_socket.bind(proxy_address) #assigns an IP address and a port number to a socket instance.
        proxy_socket.listen(1) ##maximum number of connections that can be queued for this socket.
        # * Fill in end (1)
